...
- `PRODUCTION_APP_API_URL`, `PRODUCTION_APP_API_KEY`: (Optional) Production app base URL and shared Bearer secret for **Send to production** on orders. See `PRODUCTION_APP_INTEGRATION.md`.
