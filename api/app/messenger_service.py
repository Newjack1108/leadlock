...
def get_user_profile(
    ...
    """
    Fetch user profile (first_name, last_name) from Graph API.
    Returns (success, first_name, last_name, error_message).
    """
    token = page_access_token or get_page_access_token()
    if not token:
        return False, None, None, "Facebook Messenger not configured"
    ...
    try:
        with httpx.Client(timeout=10.0) as client:
            ...
            return True, first or None, last or None, None
    except Exception as e:
