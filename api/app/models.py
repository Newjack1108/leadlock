...
class CompanySettings(SQLModel, table=True):
    ...
    default_specification_sheet_url: Optional[str] = None  # Default specification sheet file (PDF/PNG/JPG)
...
class Quote(SQLModel, table=True):
    ...
    deposit_amount: Decimal = Field(default=0, sa_column=Column(Numeric(10, 2)))  # Deposit amount inc VAT (staff sheds 20% commission default; else 50%)
